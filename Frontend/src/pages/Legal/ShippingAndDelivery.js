          ...
          <div className="col-lg-8">
            <div className="legal-content">
              ...
              <section className="legal-section">
                ...
                <p>
                  Our hotel booking platform provides instant digital services.
                  All bookings, confirmations, and related services are
                  delivered electronically through our secure platform.
                </p>
                ...
                <div className="policy-highlight">
                  ...
                  <ul>
                    <li>
                      <strong>Booking Confirmations:</strong> Immediate email
                      confirmation
                    </li>
                    <li>
                      <strong>Receipts:</strong> Instant digital receipts
                    </li>
                    <li>
                      <strong>Vouchers:</strong> Digital vouchers delivered via
                      email
                    </li>
                    <li>
                      <strong>Updates:</strong> Real-time booking status updates
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section className="legal-section">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Express Delivery:</strong> 1 business day
                    (additional charges apply)
                  </li>
                  <li>
                    <strong>Same Day:</strong> Available for urgent requests
                    (premium pricing)
                  </li>
                </ul>
              ...
              <section className="legal-section">
                ...
                <div className="contact-info">
                  <p>
                    <strong>Technical Support:</strong> +1 (555) 123-4567
                  </p>
                  <p>
                    <strong>Email Support:</strong> delivery@hotelbooking.com
                  </p>
                  <p>
                    <strong>Live Chat:</strong> Available 24/7 on our website
                  </p>
                  <p>
                    <strong>Response Time:</strong> Under 2 hours for urgent
                    issues
                  </p>
                </div>
              </section>
              ...
              <section className="legal-section">
                ...
                <p>
                  This shipping and delivery policy may be updated to reflect
                  changes in our services or legal requirements. Updates will be
                  posted on this page with the revision date.
                </p>
              </section>
            </div>
          </div>
